  ...
  _embedded: {
    products: [
      ...
      },
      {
        ...
        name: 'A-Trust',
        shortDescription:
          'Clearly authenticate your Austrian customers with a mobile phone signature.',
        logoUrl:
      ...
      },
      {
        ...
        name: 'Mailstore',
        shortDescription:
          'Enhance business processes by streamlining email management, supporting both IMAP and POP3 with robust SSL encryption.',
        logoUrl:
